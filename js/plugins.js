    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                arrows: true,
                asNavFor: null,
                prevArrow: '<button type="button" data-role="none" class="slick-prev" aria-label="previous"> <svg class="icon icon-prev"> <use xlink:href="#icon-prev"></use> </svg> </button>',
                nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="next"> <svg class="icon icon-next"> <use xlink:href="#icon-next"></use> </svg> </button>',
                autoplay: false,
                autoplaySpeed: 3000,
                centerMode: false,
                centerPadding: '50px',
...
(function($){
    ...
    $.fn.enllax = function(opt){
        ...
        elem.each(function(){
            ...
            var dataFade = $this.data('enllax-fade');
            ...
            $(window).on('scroll', function(){
                ...
                fadeRatio = ( (offset - (scrolling / 2) ) / 100);
